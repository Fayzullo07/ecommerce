        ...
        <main className=" bg-white relative overflow-hidden py-4">
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-2 h-[95vh]">
                    ...
                    <div className="grid grid-cols-2 grid-rows-3 gap-4 *:rounded-2xl">
                        <div className="col-span-2 row-span-2 border bg-blue-300 relative">
                            {/* <img className="h-60 w-60  absolute bottom-0 right-0 hover:scale-105 duration-300" src="src/assets/foiz.png" alt="Converse sneakers" /> */}
                        </div>
